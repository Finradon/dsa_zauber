...
kosten12 = round(10 + (args.meilen/16) + 7 * args.personen + (args.meilen/8) * args.personen)
kosten15 = round(10 + (args.meilen/32) + 7 * args.personen + (args.meilen/16) * args.personen)
